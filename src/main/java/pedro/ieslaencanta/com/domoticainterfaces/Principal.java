...
import pedro.ieslaencanta.com.domoticainterfaces.devices.Alarm;
...
import pedro.ieslaencanta.com.domoticainterfaces.devices.Dimmer;
import pedro.ieslaencanta.com.domoticainterfaces.devices.Light;
import pedro.ieslaencanta.com.domoticainterfaces.devices.Thermometer;
...
public class Principal extends Application {
    ...
    private void initmap() {
       ...
       //luz
        ...
        d= new Thermometer("Luces del Monte Calvario","monte",7f);
        this.mapa.addMarker(this.addDevice(d,new Coordinate( 38.09007296147201, -0.7201849554056535)));
        d= new Alarm("Luces del Monte Calvario","monte",false,10f);
        this.mapa.addMarker(this.addDevice(d,new Coordinate( 38.08762903154315, -0.730114580218533)));
      /* 
